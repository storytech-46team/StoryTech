...
1. [Описание продукта](#Описание-продукта)
    1.1 [Глоссарий с основными терминами и сокращениями](#Глоссарий-с-основными-терминами-и-сокращениями) 
...
нечто идеальное, но существующее лишь в теории. Совершенно невозможное для применения на практике. Однако, в теории — "живет и работает" прекрасно.
