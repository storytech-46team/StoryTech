...
Для генерации текстов в нашем проекте используется LLM от OpenAI по API, но с использованием прокси, который указывается в питон коде.
Необходимо:
1. API от OpenAI
2. Прокси, который будет позволять подключаться 
